...
// [id] this folder is for dynamic routing for id 
...
const SingleProduct = () => {
    ...
    const qty = form.watch('qty'); // it is like a on change method - when qty changes it will give you value
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)}>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {session ? (
                                            ...
                                            // callbackurl will help us to return to this page after signin
